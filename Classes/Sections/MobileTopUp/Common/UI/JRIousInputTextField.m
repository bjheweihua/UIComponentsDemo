...
@interface JRIousInputTextField ()
...
@implementation JRIousInputTextField
...
-(void)setFloatingLabelText:(NSString *)floatingLabelText
{
    ...
    _floatingLabel.font = _floatingLabelFont !=nil ? _floatingLabelFont : [UIFont getSanFranciscoFont:12.0 Weight:KSFWeightRegular];
    [_floatingLabel sizeToFit];
    [self calculateSize];
...
-(void)calculateSize
{
    ...
    _activeSize = CGSizeMake(_normalSize.width, _activeSize.height);
}
...
- (void)hideFloatingLabel:(BOOL)animated
{
    void (^hideBlock)() = ^{
        ...
        _floatingLabel.frame = CGRectMake(_floatingLabel.frame.origin.x,
                                          ...
                                          _normalSize.width,
                                          _normalSize.height);
        _floatingLabel.textColor = [UIColor jrColorWithHex:@"#CCCCCC"];
